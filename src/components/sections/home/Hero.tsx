...
const DEFAULT_HERO = {
  badge: 'New: Enterprise AI Features',
  title: 'Scale your business with',
  titleHighlight: 'intelligent SaaS automation',
  description:
    'Streamline operations, boost productivity, and accelerate growth with our AI-powered platform. Built for modern teams who demand performance and reliability.',
  features: [
